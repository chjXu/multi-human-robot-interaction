...
def main():
    # no --, the params is required.
    parser = argparse.ArgumentParser(description="Show a frame with overlaid skeletons.")
    parser.add_argument('--data_path', type=str, default='/media/xuchengjun/D/dataset/panoptic-toolbox/170407_haggling_a1')
    parser.add_argument('--panel', type=int, default=0)
    parser.add_argument('--node', type=int, default=0)
    parser.add_argument('--frame', type=int, default=0)
    parser.add_argument('--outputfile', type=str, nargs='?', default='/media/xuchengjun/D/dataset/panoptic-toolbox/output/')
    ...
    while(frame < 15000):
        ...
        outputfile = args.outputfile + '{3}_{0:02d}_{1:02d}_{2:08d}.jpg'.format(panel,node,frame,seq_name)
