...
//
// Generated at: 2021-06-04 16:20:52.700491
//
...
pub const MPC_CONTROLLER_NUM_DECISION_VARIABLES: usize = 3;

/// Number of parameters
pub const MPC_CONTROLLER_NUM_PARAMETERS: usize = 4;
...
const CONSTRAINTS_XMIN :Option<&[f64]> = Some(&[-5.0,-5.0,-5.0,]);
const CONSTRAINTS_XMAX :Option<&[f64]> = Some(&[5.0,5.0,5.0,]);
